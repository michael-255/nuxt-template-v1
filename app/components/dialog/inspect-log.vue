          ...
          <div class="page-width-limit">
            <QList padding>
              <div v-if="record">
                ...
                <DialogBaseItemDate label="Created Date" field="created_at" :record />
                <DialogBaseItemText label="Log Level" field="log_level" :record />
                <DialogBaseItemText label="Label" field="label" :record />
                <DialogBaseItemObject label="Details" field="details" :record />
              </div>
            </QList>
            <div class="q-mt-xl" />
          </div>
